...
(function() {
    const PRO_EXERCISES = {
        'Pectorales': [
            ...
            { name: 'Press Plano (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=679p9qL-wY' },
            { name: 'Press Inclinado (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=679iPEnn-ltC8' },
            { name: 'Aperturas Planas (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=eGjt4lk6g34' },
            { name: 'Aperturas en Peck Deck', videoUrl: 'https://www.youtube.com/watch?v=679id882M_39E' },
            ...
            { name: 'Fondos en Paralelas (Pecho)', videoUrl: 'https://www.youtube.com/watch?v=679z8JmcrW-As' },
            ...
            { name: 'Press de Banca con Agarre Invertido', videoUrl: 'https://www.youtube.com/watch?v=679p9qL-wY' },
            ...
            { name: 'Press de Banca con Mancuernas con Agarre Neutro', videoUrl: 'https://www.youtube.com/watch?v=679iPEnn-ltC8' },
        ...
        'Lumbares': [
            ...
            { name: 'Buenos Días con Barra', videoUrl: 'https://www.youtube.com/watch?v=679S8vR3XUaA' },
            ...
            { name: 'Bird Dog (Perro de caza)', videoUrl: 'https://www.youtube.com/watch?v=679XLEnwUr1gk' },
        ...
        'Hombros': [
            { name: 'Press Militar (Barra)', videoUrl: 'https://www.youtube.com/watch?v=679yjwxtZ_Vkg' },
            { name: 'Press Militar (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=hzV0is76j5I' },
            { name: 'Press Arnold', videoUrl: 'https://www.youtube.com/watch?v=679mcHe6Pvefc' },
            { name: 'Elevaciones Laterales (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=679VcKaXpzqRo' },
            ...
            { name: 'Pájaros (Mancuernas)', videoUrl: 'https://www.youtube.com/watch?v=679yMdhi2DVao' },
            ...
            { name: 'Pájaros en Peck Deck Invertido', videoUrl: 'https://www.youtube.com/watch?v=679yWTVfXNntc' },
            { name: 'Press Militar con Mancuernas Sentado', videoUrl: 'https://www.youtube.com/watch?v=hzV0is76j5I' },
            { name: 'Elevaciones Laterales Inclinadas (Mancuerna)', videoUrl: 'https://www.youtube.com/watch?v=679VcKaXpzqRo' },
            { name: 'Elevaciones Frontales con Disco', videoUrl: 'https://www.youtube.com/watch?v=gzXoI26vT_o' },
            { name: 'Pájaros Sentado', videoUrl: 'https://www.youtube.com/watch?v=679yMdhi2DVao' },
            { name: 'Press de Hombros en Máquina Smith', videoUrl: 'https://www.youtube.com/watch?v=679yjwxtZ_Vkg' },
            ...
            { name: 'Elevaciones Laterales en Máquina', videoUrl: 'https://www.youtube.com/watch?v=679VcKaXpzqRo' },
        ...
        'Cuadriceps': [
            ...
            { name: 'Sentadilla Búlgara (Foco Cuádriceps)', videoUrl: 'https://www.youtube.com/watch?v=679C-uNgKwPLE' },
            ...
            { name: 'Step Ups con Mancuernas', videoUrl: 'https://www.youtube.com/watch?v=679_C8p9pNc6U' },
            { name: 'Prensa de Piernas a una pierna', videoUrl: 'https://www.youtube.com/watch?v=yZ800I4r_0g' },
            { name: 'Sentadilla Búlgara con Mancuernas', videoUrl: 'https://www.youtube.com/watch?v=679C-uNgKwPLE' },
        ...
        'Isquiotibiales': [
            { name: 'Curl Femoral Tumbado', videoUrl: 'https://www.youtube.com/watch?v=679Tq3QdAUUoI' },
            ...
            { name: 'Curl Femoral con Fitball', videoUrl: 'https://www.youtube.com/watch?v=679Tq3QdAUUoI' },
            ...
            { name: 'Curl Femoral con Mancuerna entre pies', videoUrl: 'https://www.youtube.com/watch?v=679Tq3QdAUUoI' },
            ...
            { name: 'Curl Femoral en Polea', videoUrl: 'https://www.youtube.com/watch?v=679Tq3QdAUUoI' },
        ...
        'Glúteos': [
            ...
            { name: 'Zancada Búlgara (Foco Glúteo)', videoUrl: 'https://www.youtube.com/watch?v=679C-uNgKwPLE' },
            { name: 'Step Up (Cajón Alto)', videoUrl: 'https://www.youtube.com/watch?v=679_C8p9pNc6U' },
            ...
            { name: 'Zancadas cruzadas (Curtsy Lunges)', videoUrl: 'https://www.youtube.com/watch?v=679C-uNgKwPLE' },
            ...
            { name: 'Sentadilla Sumo con Mancuerna', videoUrl: 'https://www.youtube.com/watch?v=679_C8p9pNc6U' },
        ...
        'Triceps': [
            { name: 'Press Francés', videoUrl: 'https://www.youtube.com/watch?v=679u1_NreL7mU' },
            { name: 'Extensiones en Polea Alta', videoUrl: 'https://www.youtube.com/watch?v=679-LAMcpzHLU' },
            { name: 'Patada de Tríceps (Polea)', videoUrl: 'https://www.youtube.com/watch?v=679SS6K3lAwZ8' },
            { name: 'Press de Banca Estrecho', videoUrl: 'https://www.youtube.com/watch?v=wX-EPr_x4_A' },
            { name: 'Extensiones tras nuca', videoUrl: 'https://www.youtube.com/watch?v=679XhS6_q1Vtc' },
            { name: 'Patada de Tríceps con Mancuerna', videoUrl: 'https://www.youtube.com/watch?v=679SS6K3lAwZ8' },
            { name: 'Fondos entre Bancos (Tríceps)', videoUrl: 'https://www.youtube.com/watch?v=679z8JmcrW-As' },
            { name: 'Press Francés con Mancuernas', videoUrl: 'https://www.youtube.com/watch?v=679u1_NreL7mU' },
            { name: 'Extensión de Tríceps por encima de la cabeza en Polea', videoUrl: 'https://www.youtube.com/watch?v=679XhS6_q1Vtc' },
            { name: 'Fondos en Máquina para Tríceps', videoUrl: 'https://www.youtube.com/watch?v=679z8JmcrW-As' },
            { name: 'Rompecráneos (Skull Crushers) con barra EZ', videoUrl: 'https://www.youtube.com/watch?v=679u1_NreL7mU' },
            { name: 'Extensión de Tríceps unilateral en Polea', videoUrl: 'https://www.youtube.com/watch?v=679-LAMcpzHLU' },
            { name: 'Flexiones de diamante en banco', videoUrl: 'https://www.youtube.com/watch?v=wX-EPr_x4_A' },
            { name: 'Extensión de Tríceps con mancuerna a dos manos', videoUrl: 'https://www.youtube.com/watch?v=679XhS6_q1Vtc' },
            { name: 'Extensiones de Tríceps con Cuerda invertida', videoUrl: 'https://www.youtube.com/watch?v=679-LAMcpzHLU' }
        ],
        'Antebrazo': [
        ...
        'Abdominales': [
            ...
            { name: 'Dead Bug', videoUrl: 'https://www.youtube.com/watch?v=679XLEnwUr1gk' },
            ...
            { name: 'Giros Rusos (Russian Twists)', videoUrl: 'https://www.youtube.com/watch?v=679XLEnwUr1gk' },
