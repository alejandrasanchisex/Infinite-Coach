        ...
        try {
            ...
            const mapDietFromSQL = r => {
                ...
                return {
                    ...
                    isTemplate: r.is_template !== undefined ? r.is_template : (!r.client_id && r.status !== 'archived'),
                    createdAt: r.created_at,
                    updatedAt: r.updated_at
                };
            };
        ...
        try {
            ...
            if (!isTrainer && clientId) {
                ...
                const profileData = {
                    ...
                    muscleGroupsConfig: fullData.muscleGroupsConfig || {},
                    supplementationTemplates: fullData.supplementationTemplates || [],
                    library: fullData.library || [],
                    foods: fullData.foods || [],
