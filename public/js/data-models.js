...
const BrandConfig = {
  ...
  get: () => {
    ...
    if (isAlejandra) {
        ...
        defaultBrand = {
            name: 'Lucy Tundidor',
            logo: 'https://bieeydhacavxymoosasx.supabase.co/storage/v1/object/public/Media/lucy_logo_cropped.png?v=776',
            configured: true,
            colors: { 
                primary: '#816e61', 
                secondary: '#a79788', 
    ...
    if (isLucy && res && (res.name === 'Lucy Tundidor' || defaultBrand.name === 'Lucy Tundidor')) {
        ...
        if (!res.logo || res.logo === 'img/logo-infinite-coach.png' || res.logo.includes('1779724548154') || res.logo.includes('lucy_logo_v1.png') || !res.logo.includes('lucy_logo_cropped.png?v=776')) {
            res.logo = defaultBrand.logo;
            changed = true;
        }
        const expectedQuestions = [
